...
namespace SCFP_Compress.SeeCompressFilePassword
{
    public partial class frmRegister : Form
    {
        ...
        public frmRegister(Form frmfrom)
        {
            InitializeComponent();
        ...
        private void btnRegister_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                var request = new RestRequest(BaseConstants.RESTRegisterURL_Short, Method.POST);
          ...
          (response.ResponseStatus == ResponseStatus.Completed))) // It's probably not necessary to test both
                {
                    ...
                    var returnuser = SimpleJson.DeserializeObject<SCFP_user_send>(content);
