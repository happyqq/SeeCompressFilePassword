...
namespace Models
{
  ...
  //payrewards_score int(10) unsigned NOT NULL DEFAULT '0',		# 扣悬赏数分数
    public class SCFP_user_recv
    {
        ...
        public int all_score { get; set; }
        public int pay_score { get; set; }
        public int scans { get; set; }
        public int scans_score { get; set; }
        public int tasks { get; set; }
        public int tasks_score { get; set; }
        public int getrewards { get; set; }
        public int getrewards_score { get; set; }
        public int payrewards { get; set; }
        public int payrewards_score { get; set; }
